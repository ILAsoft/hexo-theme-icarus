...
module.exports = class extends Component {
    render() {
        ...
        const { url_for, date, date_xml, __, _p, is_tweet, is_page } = helper;
        ...
        return <Fragment>
            ...
            <div class="card">
                ...
                <article class={`card-content article${'direction' in page ? ' ' + page.direction : ''}`} role="article">
                    {!pager ? <div class="article-meta is-size-7 is-uppercase level is-mobile">
                        <div class="level-left">
                            ...
                            {/* Last Update Date */}
                            {page.updated && page.date && page.date != page.date && <span class="level-item" dangerouslySetInnerHTML={{
                    ...
                    {/* "Read more" button */}
                    {index && page.excerpt ? <a class="article-more button is-size-7 size-small" href={`${url_for(page.link || page.path)}#more`}>{__('article.more')}</a> : null}
                    {/* Licensing block */}
